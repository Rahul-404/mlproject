...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            beat_model_score = max(sorted(model_report.values()))

            ## To get best model name from dict
            best_model_name = list(model_report.keys())[
                list(model_report.values()).index(beat_model_score)
            ]
            ...
            with mlflow.start_run():
                ...
                if tracking_url_type_store != "file":
                    # Register the model
                    # There are other ways to use the Model Registry , which dependes on the 
                    # please refer to the doc for more information
                    # https://mlflow.org/docs/latest/model-registry.html#api-work
